...
tinymce.PluginManager.add('codehighlight', function(editor, url) {
    function showDialog() {
        var win,
            data = {},
            dom = editor.dom;
        ...
        win = editor.windowManager.open({
            ...
            file: tinyMCE.baseURL + '/plugins/codehighlight/codehighlight.html',
            width: 600,
            height: 510,
            inline: 1,
            resizable: true,
    ...
    editor.addButton('codehighlight', {
        //text: 'mc_pages',
        icon: true,
        image: url+'/img/codehighlight.png',
        tooltip: "codehighlight Title",
        onclick: showDialog,
